...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.logo_label.setGeometry(QtCore.QRect(569, 10, 161, 151))
        self.logo_label.setText("")
        self.logo_label.setObjectName("logo_label")
        self.gridLayoutWidget = QtWidgets.QWidget(self.syncTab)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(10, 10, 371, 134))
        ...
        self.adpDataFSStatusLabel = QtWidgets.QLabel(self.gridLayoutWidget)
        self.adpDataFSStatusLabel.setText("")
        self.adpDataFSStatusLabel.setObjectName("adpDataFSStatusLabel")
        self.gridLayout.addWidget(self.adpDataFSStatusLabel, 2, 1, 1, 1)
        self.adpRecordCount = QtWidgets.QLabel(self.gridLayoutWidget)
        self.adpRecordCount.setObjectName("adpRecordCount")
        self.gridLayout.addWidget(self.adpRecordCount, 2, 2, 1, 1)
        self.adpParseStatusLabel = QtWidgets.QLabel(self.gridLayoutWidget)
        self.adpParseStatusLabel.setText("")
        self.adpParseStatusLabel.setObjectName("adpParseStatusLabel")
        self.gridLayout.addWidget(self.adpParseStatusLabel, 3, 1, 1, 1)
        ...
        self.btn_sync.setGeometry(QtCore.QRect(10, 160, 371, 51))
        self.btn_sync.setObjectName("btn_sync")
        self.btn_quit = QtWidgets.QPushButton(self.syncTab)
        self.btn_quit.setGeometry(QtCore.QRect(10, 210, 371, 51))
        self.btn_quit.setObjectName("btn_quit")
        self.syncProgressBar = QtWidgets.QProgressBar(self.syncTab)
        self.syncProgressBar.setGeometry(QtCore.QRect(20, 400, 711, 23))
        self.syncProgressBar.setProperty("value", 24)
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(10, 10, 476, 191))
